$('#test').click(function(){
    ...
    var text1 = $(ans).find('ol li:nth-child(1)').text();
    var text2 = $(ans).find('ol li:nth-child(2)').text();
    var text3 = $(ans).find('ol li:nth-child(3)').text();

    if(text1 == "Sun" && text2 == "Moon" && text3 == "Stars"){
